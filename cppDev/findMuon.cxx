...
std::tuple<Int_t, Int_t, Int_t, Int_t, Double_t, Double_t, Double_t, Double_t, Double_t, Double_t> findTrack( Double_t inX, Double_t inY, Double_t inZ, Double_t inMuTheta, Double_t inMuPhi, Double_t inMuLen, Int_t j, TTree *myTree ) {
  ...
  */
  ...
  return std::make_tuple( chosenRun, chosenSubrun, chosenEvent, chosenVtxid, closestX, closestY, closestZ, closestMuTheta, closestMuPhi, closestMuLen ); 
